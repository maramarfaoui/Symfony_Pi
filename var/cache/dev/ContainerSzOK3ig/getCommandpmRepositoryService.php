 ...
 */
class getCommandpmRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CommandpmRepository' shared autowired service.
     *
     * @return \App\Repository\CommandpmRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CommandpmRepository.php';

        return $container->privates['App\\Repository\\CommandpmRepository'] = new \App\Repository\CommandpmRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
