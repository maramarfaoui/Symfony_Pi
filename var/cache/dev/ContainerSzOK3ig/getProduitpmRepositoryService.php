 ...
 */
class getProduitpmRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ProduitpmRepository' shared autowired service.
     *
     * @return \App\Repository\ProduitpmRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ProduitpmRepository.php';

        return $container->privates['App\\Repository\\ProduitpmRepository'] = new \App\Repository\ProduitpmRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
